...
Duration=${payload.duration} `
  ...
  async _onReinvite(dlg, req, res) {
    try {
      ...
      offerMedia = { ...offerMedia, ...({ codec: { mask: acceptCodecs, transcode: 'pcmu,pcma' } })};
      answerMedia = { ...answerMedia, ...({ codec: {offer:
      ...
      answerMedia = { ...answerMedia, ...({ codec: { mask: acceptCodecs, transcode: 'pcmu,pcma' } })};
