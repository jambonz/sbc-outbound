...
Duration=${payload.duration} `
  ...
  async _onReinvite(dlg, req, res) {
    try {
      ...
      offerMedia = { ...offerMedia, ...(acceptCodecs && { codec: { mask: acceptCodecs, transcode: 'pcmu,pcma' } })};
      answerMedia = { ...answerMedia, ...(process.env.JAMBONES_CODEC_OFFER_WITH_ORDER && { codec: {offer:
